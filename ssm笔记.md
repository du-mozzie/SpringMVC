...
<beans xmlns="http://www.springframework.org/schema/beans"
   ...
   <!-- 配置整合mybatis -->
   <!-- 1.关联数据库文件 -->
       <context:property-placeholder location="+`1q`-`-`-database.properties"/>
...
![image-20210523174258640](SpringMVC.assets/image-20210523174258640.png)



![image-20210523174306856](SpringMVC.assets/image-20210523174306856.png)
